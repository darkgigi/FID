...
```{r}
# Model List Dalc
models_dalc <- list(GLM = glm_dalc, GLMNET = glmnet_dalc, GLMNETTUNING = glmnet_tuning_dalc, RPART = rpart_dalc, RF = rf_dalc, GBM = gbm_dalc, XGB = xgboost_dalc, NB = nb_dalc)
...
```{r}
# Model List Walc
models_walc <- list(GLM = glm_walc, GLMNET = glmnet_walc, GLMNETTUNING = glmnet_tuning_walc, RPART = rpart_walc, RF = rf_walc, GBM = gbm_walc, XGB = xgboost_walc, NB = nb_walc)
