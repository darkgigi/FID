...
ga_Hdalc <- ga(
  ...
  maxiter = 50,       # Número máximo de generaciones
...
pso_Hdalc <- psoptim(
  ...
  control = list(maxit = 50, s = 50, trace = 1)
)
...
pso_Hdalc <- psoptim(
  ...
  control = list(maxit = 100, s = 50, trace = 1)  # Configuración del PSO
)
...
pso_Hwalc <- psoptim(
  ...
  lower = rep(0, n_features),
  upper = rep(1, n_features),
  control = list(maxit = 100, s = 50, trace = 1)
)
# Características seleccionadas para Hdalc
